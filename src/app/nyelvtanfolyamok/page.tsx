      ...
      <section className="grain-overlay vignette section-silk relative overflow-hidden bg-[#0a0a0f] pb-20 pt-32">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <SectionHeading
            as="h1"
            tone="dark"
            title="Nyelvtanfolyamok"
            subtitle="Tanfolyamaink min. 5 fő jelentkezése esetén indulnak. Online nyelvtanfolyamainkon a Zoom programot használjuk."
          />
        </div>
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative mb-12 rounded-[1.5rem] border border-accent/20 bg-white p-8 shadow-sm">
            ...
            <h3 className="mb-4 flex items-center gap-2 text-xl font-bold text-primary">
              <span>📋</span> Jelentkezés menete
            </h3>
            <ol className="list-decimal list-inside space-y-2 text-sm leading-relaxed text-text-secondary">
              <li>Online jelentkezés a weboldalon</li>
              <li>Visszaigazoló e-mail, ha elértük a minimum 5 fős létszámot</li>
              <li>Tandíj befizetése az ELTE ePay rendszerén keresztül (epay.elte.hu)</li>
              <li>Befizetési igazolás küldése az edu@konfuciusz.elte.hu címre</li>
              <li>Felnőttképzési szerződés aláírása</li>
            </ol>
          </div>
          ...
          <div className="mb-8 flex flex-col gap-4 sm:flex-row">
            <div className="relative max-w-md flex-1">
              ...
              <input
                type="text"
                placeholder="Keresés szint, oktató vagy kód alapján..."
                value={searchTerm}
            ...
            <div className="flex gap-2">
              {(
                [
                  { value: "all" as FilterType, label: "Összes" },
                  { value: "online" as FilterType, label: "🖥 Online" },
                  { value: "classroom" as FilterType, label: "🏫 Jelenléti" },
                  { value: "hybrid" as FilterType, label: "🔄 Hibrid" },
                ] as const
              ).map((btn) => (
                <button
                  key={btn.value}
          ...
          <SectionHeading
            title={`Induló nyelvtanfolyamok (${filteredCourses.length})`}
            tone="light"
            withSeal={false}
            className="mb-8"
          />
            ...
            {filteredCourses.map((course) => (
              ...
              >
                ...
                <div className="space-y-2 text-sm text-text-secondary">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-accent">🕐</span> {course.schedule}, {course.time}
                  </div>
                  <div className="flex items-center gap-2">
          ...
          {filteredCourses.length === 0 && (
            <div className="py-16 text-center">
              <p className="text-lg text-text-secondary">Nincs találat a megadott feltételekkel.</p>
            </div>
          )}
        </div>
      ...
      <section className="grain-overlay vignette section-silk relative overflow-hidden bg-[#0a0a0f] py-20">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <SectionHeading
            ...
            subtitle="Fedezze fel a kínai kultúra művészeti ágait kalligráfia- és festészeti tanfolyamainkon."
            className="mb-12"
          />
          ...
          <div className="grid gap-8 md:grid-cols-2">
            {culturalCourses.map((course, i) => (
              ...
              >
                ...
                <h3 className="mb-3 text-lg font-bold text-gold-shimmer">{course.title}</h3>
                <p className="mb-5 text-sm leading-relaxed text-cream/80">{course.description}</p>

                <div className="grid grid-cols-2 gap-3 text-sm text-cream/70">
                  <div className="flex items-center gap-2">
                    <span className="text-accent">📅</span> {course.startDate}
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-accent">🕐</span> {course.schedule}
                  </div>
                  <div className="flex items-center gap-2">
                ...
                <div className="mt-5 border-t border-accent/20 pt-4">
                  <span className="font-bold text-accent">{course.fee}</span>
                </div>
              </TiltCard>
            ))}
          </div>
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="relative rounded-[1.5rem] border border-accent/20 bg-white p-8 shadow-sm">
            ...
            <p className="mb-4 max-w-2xl text-text-secondary">
              Egyéni igényekre szabott magánórák is elérhetők. Az óraszámot és az időbeosztást egyénileg egyeztetjük.
            </p>
            <p className="text-sm">
              Érdeklődés:{" "}
              <a
